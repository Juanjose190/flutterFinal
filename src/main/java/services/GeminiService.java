...
public class GeminiService {
    ...
    public static String generarHorario(String prompt) {
        ...
        // Estructura de request para Gemini
    ...
    public static String construirPrompt(String profesores, String materias, String aulas, String restricciones) {
