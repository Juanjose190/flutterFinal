...
abstract class AppLocalizations {
  ...
  /// No description provided for @specialClassroom.
  ///
  /// In en, this message translates to:
  /// **'Special Classroom'**
  String get specialClassroom;
  ...
  /// No description provided for @missingEnv.
  ///
  /// In en, this message translates to:
  /// **'Missing environment configuration'**
  String get missingEnv;
}
