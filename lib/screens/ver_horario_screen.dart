              ...
              child: horario == null
                  ? Column(
                      ...
                      children: [
                        GlassCard(
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                'aprobado: $aprobado • pendiente: $pendiente • borrador: $borrador',
                              ),
                            ],
                          ),
                        ),
                        const SizedBox(height: 12),
                        const Text(
                          'Genera un horario desde la opción "Generar horario con IA".',
                        ),
                      ],
                    )
                  : Column(
                            ...
                            children: [
                              ...
                              AnimatedSwitcher(
                                ...
                                child: DropdownButton<HorarioStatus>(
                                  ...
                                  items: const [
                                    DropdownMenuItem(
                                      value: HorarioStatus.aprobado,
                                      child: Text('aprobado'),
                                    ),
                                    DropdownMenuItem(
                                      value: HorarioStatus.pendiente,
                                      child: Text('pendiente'),
                                    ),
                                    DropdownMenuItem(
                                      value: HorarioStatus.borrador,
                                      child: Text('borrador'),
                                    ),
                                  ],
                        ...
                        GlassCard(
                          child: Column(
                            ...
                            children: const [
                              ...
                              ListTile(
                                title: Text(
                                  'Lunes 8:00 - Matemáticas - Aula 101',
                                ),
                              ),
                              ListTile(
                                title: Text('Martes 10:00 - Lengua - Aula 202'),
                              ),
                              ListTile(
                                title: Text(
                                  'Miércoles 9:00 - Historia - Laboratorio',
                                ),
                              ),
                            ],
                          ),
