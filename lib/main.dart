      ...
      routes: [
        ...
        GoRoute(
          ...
          pageBuilder: (context, state) => _fadeSlide(
            DocenteFormScreen(docente: state.extra as Docente?),
          ),
        ),
        GoRoute(
          path: '/materias',
        ...
        GoRoute(
          ...
          name: 'materia_form',
          pageBuilder: (context, state) => _fadeSlide(
            MateriaFormScreen(materia: state.extra as Materia?),
          ),
        ),
        GoRoute(
          path: '/aulas',
        ...
        GoRoute(
          ...
          name: 'aula_form',
          pageBuilder: (context, state) => _fadeSlide(
            AulaFormScreen(aula: state.extra as Aula?),
          ),
        ),
        GoRoute(
          path: '/generar',
          name: 'generar',
          pageBuilder: (context, state) => _fadeSlide(const GenerarHorarioScreen()),
        ),
        GoRoute(
          path: '/horario',
          name: 'horario',
          pageBuilder: (context, state) => _fadeSlide(
            VerHorarioScreen(horario: state.extra as Horario?),
          ),
        ),
      ],
    );
            ...
            return AnimatedTheme(
              ...
              child: AnimatedSwitcher(
                ...
                transitionBuilder: (c, anim) {
                  final fade = CurvedAnimation(parent: anim, curve: Curves.easeInOutCubic);
